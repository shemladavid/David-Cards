...
function s.abysskite(c)
	return c:IsSpell() and c:IsSetCard(SET_ABYSSKITE)
end
function s.thfilter(c)
	return c:IsAbleToHand() and (s.abysskite(c) or c:IsCode(22977509))
end
...
function s.rescon(sg,e,tp,mg)
	return sg:FilterCount(Card.IsCode,nil,22977509)<=1
