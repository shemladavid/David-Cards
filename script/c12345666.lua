...
function s.ctrlcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.IsExistingMatchingCard(s.rmvspfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,e:GetHandler()) end
...
function s.ctrltg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.controlfilter,tp,0,LOCATION_MZONE,1,nil) end
