...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Toss a coin 3 times, destroy cards your opponent controls, up to number of heads
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chkc then return chkc:IsLocation(LOCATION_ONFIELD) and chkc:IsControler(1-tp) and s.filter(chkc,tp) end
